...
public class RepayBorrowValidator {
    @Autowired
    ...
    public boolean attachOtherTranEntries(Transaction transaction) {
        ...
        return validatorCommons.addCashAccount(totalAmount, TranType.CREDIT, transaction, transaction.getContributionsPlan().getName()+" loan in ");
    }
}
