...
public class RepayLendValidator {
    @Autowired
    ...
    public boolean attachOtherTranEntries(Transaction transaction) {
        ...
        return validatorCommons.addCashAccount(totalAmount, TranType.DEBIT, transaction, transaction.getContributionsPlan().getName()+" loan out ");
    }
}
