...
@Service
public class LoanDisbursementValidator {
    @Autowired
    ...
    public boolean attachOtherTranEntries(Transaction transaction) {
        ...
        return validatorCommons.addCashAccount(totalAmount, TranType.CREDIT, transaction, "Loan disbursement");
    }
}
